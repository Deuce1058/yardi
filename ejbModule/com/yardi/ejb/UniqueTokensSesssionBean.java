...
public class UniqueTokensSesssionBean implements UniqueTokensSesssionBeanRemote {
    ...
    public UniqueTokensSesssionBean() {
    	System.out.println("com.yardi.ejb UniqueTokensSessionBean UniqueTokensSesssionBean() 0015");
    }
	 ...
	 * @param userName
	 */
	public Vector<UniqueTokens> removeExtraTokens(Vector<UniqueTokens> userTokens) {
    	//getPwdPolicy();
	 ...
	 * @param uniqueToken
	 */
	public void removeOldestToken(Vector<UniqueTokens> userTokens) {
		//debug
	...
	private PpPwdPolicy getPwdPolicy() {
		...
		//debug
		System.out.println("com.yardi.ejb UniqueTokensSesssionBean getPwdPolicy() 000E"
			+ "\n"
			+ "   pwdPolicy="
			+ pwdPolicy
			);
	...
	private void setPwdPolicy() {
		//debug
		System.out.println("com.yardi.ejb UniqueTokensSesssionBean setPwdPolicy() 0012"
				+ "\n"
				+ "   passwordPolicyBean="
				+ passwordPolicyBean
				);
		...
		if (pwdPolicy == null) {
			System.out.println("com.yardi.ejb UniqueTokensSesssionBean setPwdPolicy() pwdPolicy==null 000F");
			return;
		}
		//debug
		System.out.println("com.yardi.ejb UniqueTokensSesssionBean setPwdPolicy() 0010"
			+ "\n"
			+ "   pwdPolicy="
			+ pwdPolicy
			);
