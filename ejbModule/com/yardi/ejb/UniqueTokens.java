...
@NamedQuery(name="UniqueTokens.findAll", query="SELECT u FROM UniqueTokens u")
public class UniqueTokens implements Serializable {
	...
	public UniqueTokens(String up1UserName, String up1Token, Date up1DateAdded) {
	...
	public String toString() {
		return "UniqueTokens [up1UserName=" + up1UserName + ", up1Token="
